...
$astroway_cards = [
	...
	[
		...
		'description' => __( 'Compatibility score and the cross-aspects behind it, for two birth charts. Rendered into the page; no key needed.', 'astroway' ),
		'example'     => '[astroway_synastry name_a="Olena" date_a="1990-05-15" time_a="14:30" lat_a="50.45" lon_a="30.52" tz_a="Europe/Kyiv" name_b="Marc" date_b="1988-11-02" time_b="09:15" lat_b="52.52" lon_b="13.40" tz_b="Europe/Berlin"]',
		'block'       => 'astroway/synastry',
		'params'      => [
			[ 'date_a', 'string', true, __( 'First person: birth date in YYYY-MM-DD.', 'astroway' ) ],
			[ 'time_a', 'string', false, __( 'First person: birth time in HH:MM. Leave it out and the time is declared unknown rather than guessed.', 'astroway' ) ],
			[ 'lat_a', 'float', false, __( 'First person: latitude.', 'astroway' ) ],
			[ 'lon_a', 'float', false, __( 'First person: longitude.', 'astroway' ) ],
			[ 'tz_a', 'string', false, __( 'First person: IANA timezone.', 'astroway' ) ],
			[ 'name_a', 'string', false, __( 'First person: name for the table heading. Stays on your server.', 'astroway' ) ],
			[ 'date_b', 'string', true, __( 'Second person: birth date in YYYY-MM-DD.', 'astroway' ) ],
			[ 'time_b', 'string', false, __( 'Second person: birth time in HH:MM. Optional in the same way.', 'astroway' ) ],
			[ 'lat_b', 'float', false, __( 'Second person: latitude.', 'astroway' ) ],
			[ 'lon_b', 'float', false, __( 'Second person: longitude.', 'astroway' ) ],
